...
**v2.3.120** — *Edge intelligence platform: streaming, Vision LLM, semantic search, YOLO gatekeeper, adaptive rate controller, scene classification, activity timeline, object counting, smart alerts, motion heatmap*
...
│   ├── app.py               # FastAPI server (Edge Intelligence Platform v2.3.120)
...
│   ├── main.cpp             # ESP32 firmware entry point (v2.3.120 with diagnostics)
